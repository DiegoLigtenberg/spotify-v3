...
class AudioPlayer {
    ...
    async _unlockAudioContext() {
        ...
        try {
            ...
            silentAudio.src = 'data:audio/mp3;base64,';
    ...
    async _checkRangeSupport() {
        try {
            // Don't run this check if window.fetch is not available or if we're in test mode
            if (typeof window.fetch !== 'function') {
                console.log('Fetch API not available, skipping range support check');
                return;
            }

            // Safely get the fetch function to use
            const fetchFunc = this.fetch || window.fetch;
            if (!fetchFunc) {
                console.log('No fetch method available, skipping range support check');
                return;
            }
            
            try {
                // Try to get a list of songs first to find a valid ID to test with
                const songsResponse = await fetchFunc('/api/songs?limit=1', {
                    method: 'GET',
                ...
                const songId = songsData && songsData.songs && songsData.songs.length > 0 ? 
                              songsData.songs[0].id : 'test';
                
                // Make the range support check with a known valid ID or fall back to a test value
                const response = await fetchFunc(`/api/stream/${songId}`, {
                    method: 'HEAD',
                    // Add timeout to prevent hanging
                    signal: AbortSignal.timeout(3000)
                });
                ...
                if (response && response.ok) {
                    console.log('Server range support check successful');
                } else {
                    console.log('Range support check returned status:', response?.status || 'unknown');
                }
            } catch (e) {
                // Handle specific fetch errors
                if (e.name === 'AbortError') {
                    console.warn('Range support check timed out');
                } else {
                    console.warn('Range support check failed:', e.message);
                }
            }
        } catch (e) {
            // Catch any unexpected errors at the top level
            console.warn('Range support check encountered an unexpected error, continuing anyway:', e);
        }
    }
    ...
    _setupAudioEvents() {
        ...
        // Additional event handlers for song loading/success
        this.audioElement.addEventListener('loadeddata', () => {
            console.log('Audio data loaded, duration:', this.formatTime(this.audioElement.duration));
            
            // Force a songChanged event when audio data is loaded
            // This is a critical moment when we know a new song is actually playing
            if (this.currentUrl) {
                // Extract the song ID from the URL if possible
                let songId = null;
                const apiMatch = this.currentUrl.match(/\/api\/stream\/(\d+)/);
                const staticMatch = this.currentUrl.match(/\/static\/audio\/(\d+)/);
                ...
                if (songId) {
                    console.log('Audio loaded: Firing critical songChanged event with ID:', songId);
                    this._fireEvent('songChanged', { songId, isLoaded: true });
                }
            }
        });
    }
    ...
    async play(streamUrl) {
        try {
            ...
            // Extract the song ID from the URL if possible, for songChanged event
            let songId = null;
            const apiMatch = streamUrl.match(/\/api\/stream\/(\d+)/);
            const staticMatch = streamUrl.match(/\/static\/audio\/(\d+)/);
            ...
            try {
                ...
                // Fire songChanged event if we have a song ID
                if (songId) {
                    console.log('Firing songChanged event with ID:', songId);
                    this._fireEvent('songChanged', { songId });
                }
    ...
    _tryDirectPlayback(url) {
        return new Promise((resolve, reject) => {
            ...
            directAudio.oncanplay = () => {
                ...
                let songId = null;
                const apiMatch = directAudio.src.match(/\/api\/stream\/(\d+)/);
                if (apiMatch && apiMatch[1]) {
                    songId = apiMatch[1];
                    console.log('Extracted song ID for songChanged event:', songId);
                    this._fireEvent('songChanged', { songId });
                }
